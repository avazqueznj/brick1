  ...
  void processPendingScreenTransition()
  {
    ...
    try
    {
      ...
      if (isNew)
      {
        ...
        case SCREEN_ID_INSPECTION_HISTORY:
          screenStates[nextScreen] = new inspectionHistoryScreenClass(&settings);
          break;
        case SCREEN_ID_INSPECTION_ZONES:
          screenStates[nextScreen] = new inspectionZonesScreenClass(&settings);
          break;
        case SCREEN_ID_INSPECTION_FORM:
          screenStates[nextScreen] = new formFieldsScreenClass(&settings);
          break;
        case SCREEN_ID_SELECT_INSPECTION_TYPE:
          screenStates[nextScreen] = new selectInspectionTypeScreenClass(&settings);
          break;
        case SCREEN_ID_SELECT_ASSET_SCREEN:
          screenStates[nextScreen] = new selectAssetScreenClass(&settings);
          break;
        case SCREEN_ID_LOGIN_SCREEN:
          screenStates[nextScreen] = new loginScreenClass(&settings);
          break;
        case SCREEN_ID_SETTINGS:
          screenStates[nextScreen] = new settingsScreenClass(&settings);
          break;
        case SCREEN_ID_MAIN:
          screenStates[nextScreen] = new mainScreenClass(&settings);
          break;
        default:
